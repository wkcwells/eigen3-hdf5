...
template <typename T>
void save_scalar_attribute (const H5::H5File &h5obj, const std::string &name, const T &value)
{
    const H5::DataType * const datatype = DatatypeSpecialization<T>::get();
...
template <>
inline void save_scalar_attribute (const H5::H5File &h5obj, const std::string &name, const std::string &value)
{
...
template <typename Derived>
void save (H5::H5File &h5group, const std::string &name, const Eigen::EigenBase<Derived> &mat, const H5::DSetCreatPropList &plist=H5::DSetCreatPropList::DEFAULT)
{
...
template <typename Derived>
void save_attribute (const H5::H5File &h5obj, const std::string &name, const Eigen::EigenBase<Derived> &mat)
{
    typedef typename Derived::Scalar Scalar;
    const Eigen::Matrix<Scalar, Eigen::Dynamic, Eigen::Dynamic, Eigen::RowMajor> row_major_mat(mat);
    const H5::DataSpace dataspace = internal::create_dataspace(mat);
...
template <typename Derived>
void load_attribute (const H5::H5File &h5obj, const std::string &name, const Eigen::DenseBase<Derived> &mat)
{
